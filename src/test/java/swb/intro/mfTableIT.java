...
public class mfTableIT {
    ...
    public void findCell() throws Exception {
        ...
        WebElement fio = driver.findElement(By.cssSelector(String.format("table#users-table tbody tr:nth-child(n) td:nth-child(%d)", columnNumber)));
//		assertEquals("Leos Belos", fio.getText());
		System.out.println("!!!!!!!column!!!!!!!! - " + columnNumber + " FIO - " + fio.getText());
    }
/*
    @Test
